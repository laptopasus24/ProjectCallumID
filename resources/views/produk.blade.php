            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    ...
                    <a href="/detailproduk" class="text-lg font-semibold mb-2">Callum Deodorant spray Tawas 100ml For Men</a>
                    <p class=" my-2">Tawas 100ml</p>
                    <div class="flex items-center mb-4">
                      <span class="text-lg font-bold text-gray-900">Rp.10.000</span>
                    </div>
                    <button class="bg-primary border border-transparent hover:bg-transparent hover:border-primary text-white hover:text-primary font-semibold py-2 px-4 rounded-full w-full">Tambah Ke keranjang</button>
                  </div>
                </div>
                <!-- Product 3 -->
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="assets/images/products/55.jpg" alt="Product 3" class="w-full object-cover mb-4 rounded-lg">
                    <a href="#" class="text-lg font-semibold mb-2">PAKET! Callum Deodorant spray Tawas 100ml </a>
                    <p class=" my-2">Tawas 100ml</p>
                    <div class="flex items-center mb-4">
                      <span class="text-lg font-bold text-primary">Rp.35.000</span>
                      <span class="text-sm line-through  ml-2">Rp.60.000</span>
                    </div>
                    <button class="bg-primary border border-transparent hover:bg-transparent hover:border-primary text-white hover:text-primary font-semibold py-2 px-4 rounded-full w-full">Add to Cart</button>
                  </div>
                </div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    ...
                    <button class="bg-primary border border-transparent hover:bg-transparent hover:border-primary text-white hover:text-primary font-semibold py-2 px-4 rounded-full w-full">Masukan Ke keranjang</button>
                  </div>
                </div>
              </div>
        </div>
