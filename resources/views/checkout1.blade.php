...
<body>
  ...
  <main class="container mx-auto p-4">
    ...
    {{-- <nav class="text-sm text-gray-500 mb-4">
      ...
      <a href="#" class="hover:text-gray-700">Keranjang</a> / 
    ...
    <section class="bg-white border rounded p-4 mb-6">
      ...
      <p class="text-gray-700"><strong>Jhon Kipli (+62) 8512345678</strong></p>
      <p class="text-gray-600">Jalan nilem, Rt1/Rw2, Kelurahan Jae, Tasikmalaya, Kota Tasikmalaya, Jawa Barat</p>
      <button class="text-sm text-blue-600 hover:underline mt-2">Ubah</button>
    </section>

    <!-- Produk Dipesan -->
    <section class="bg-white border rounded p-4 mb-6">
      <h2 class="font-bold mb-4">Produk Dipesan</h2>
      <div class="grid grid-cols-4 text-gray-700 font-semibold mb-2">
        <div>Produk</div>
        <div>Harga Satuan</div>
        <div>Jumlah</div>
        <div>Subtotal Produk</div>
      </div>
      <div class="grid grid-cols-4 items-center border-t pt-4 text-sm">
        <div class="flex items-center gap-2">
          <img src="product.jpg" alt="Product Image" class="w-16 h-16 object-cover border rounded">
          <span>Callum Deodorant</span>
        </div>
        <div>Rp.9.000</div>
        <div>2</div>
        <div>Rp.18.000</div>
    ...
    <section class="bg-white border rounded p-4 mb-6">
      ...
      <div class="space-y-4">
        <label class="flex items-start gap-4">
          <input type="radio" name="payment" class="mt-1" checked>
          <div>
            <h3 class="font-semibold text-gray-700">Transfer bank</h3>
            <p class="text-sm text-gray-600">Lakukan pembayaran Anda langsung ke rekening bank kami. Nomor rekening akan ditampilkan setelah proses ini. Pesanan Anda akan dikirim setelah kami menerima pembayaran.</p>
          </div>
        </label>
        <label class="flex items-center gap-4">
          <input type="radio" name="payment" class="mt-1">
          <span class="font-semibold text-gray-700">COD - Bayar di tempat</span>
        </label>
      </div>
    </section>
    ...
    <section class="bg-white border rounded p-4">
      <div class="grid grid-cols-2 text-gray-700 text-sm mb-4">
        <div>Subtotal Produk</div>
        <div class="text-right">Rp.18.000</div>
        <div>Subtotal Pengiriman</div>
        <div class="text-right">Rp.15.000</div>
        <div>Biaya Layanan</div>
        <div class="text-right">Rp.3.000</div>
      </div>
      <div class="border-t pt-4 font-bold text-gray-800 flex justify-between">
